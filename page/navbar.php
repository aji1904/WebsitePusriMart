<body>
	 <div>
	 	<div id="navbar">
	 		...
	 		<button class="cari"><i class="fa fa-search icon" style="size: 20px; color: gray; border-radius: 0px 5px 5px 0px;"></i></button>	
	 		<div class="w3-dropdown-hover dropdown-space">
			    ...
			    <div class="w3-dropdown-content w3-bar-block w3-border w3-center" style="width: 200px; border-radius: 5px;">
