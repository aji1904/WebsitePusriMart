	 ...
	 <div>
	 	<div id="navbar">
	 		...
	 		<div class="w3-dropdown-hover dropdown-space">
			    <button class="button provinsi " style="cursor: pointer;"><i class="fa fa-map-marker" style="size: 20px; margin: 0px 5px;"></i> Pilih Lokasi<i class="fa fa-angle-down space-dropdown"></i></button>
				...
				if (isset($_SESSION['username'])) {
					...
					echo(
						"<div class='flex-container'>
							    ...
							    <div class='w3-dropdown-content w3-bar-block w3-border' style='padding : 8px 0px;'>
							      ...
							      <a href='produk_saya.php' class='w3-bar-item w3-button'>Produk Saya</a>
							    </div>
							  </div>
